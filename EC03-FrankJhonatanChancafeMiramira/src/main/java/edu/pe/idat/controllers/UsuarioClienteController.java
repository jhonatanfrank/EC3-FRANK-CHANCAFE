package edu.pe.idat.controllers;
...
import edu.pe.idat.services.UsuarioClienteService;
...
public class UsuarioClienteController {
	...
	public ResponseEntity<Void> editar(@RequestBody UsuarioCliente usuariocliente) {
		...
		UsuarioCliente usuarioclienteObj = service.obtener(usuariocliente.getIdUsuario());

		if (usuarioclienteObj != null) {
